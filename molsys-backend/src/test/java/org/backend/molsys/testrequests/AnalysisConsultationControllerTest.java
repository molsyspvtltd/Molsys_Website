...
import org.backend.molsys.testrequests.analysisConsultation.AnalysisConsultationController;
...
@SpringBootTest
@Slf4j
class AnalysisConsultationControllerTest {


    @Autowired
    AnalysisConsultationController analysisConsultationController;;
    ...
    @Test
    @WithUserDetails(value = "analysis")
    public void calling_assignForAnalysisConsultation_with_valid_test_order_id_should_update_the_request_status(){

        TestRequest testRequest = getTestRequestByStatus(RequestStatus.SALES_REVIEW_COMPLETED);
    ...
    @Test
    @WithUserDetails(value = "analysis")
    public void calling_assignForAnalysisConsultation_with_valid_test_order_id_should_throw_exception(){
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        TestRequest testRequest = getTestRequestByStatus(RequestStatus.ANALYSIS_IN_PROCESS);
    ...
    public CreateAnalysisConsultationRequest getCreateAnalysisConsultationRequest(TestRequest testRequest) {
